...
void fill_output_file(ofstream &outputfile, Cell universe[ROWS][COLUMNS])
{
    // pre-conditions
    assert(outputfile.is_open());
    /* post-condition
        We will have filled outputfile with the current universe
    */
    for (int j = 1; j <= NO_OF_ROWS; j++)
    {
        for (int i = 1; i <= NO_OF_COLUMNS; i++)
...
int main()
{
    ...
    cout << "How many generations do you want to see?" << endl;
